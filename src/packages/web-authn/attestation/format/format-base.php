...
{
    protected $_Attestation_Object = null;
    protected $_Authenticator_Data = null;
     ...
     * @param Authenticator_Data $Authenticator_Data
     */
    public function __construct($AttestionObject, Authenticator_Data $Authenticator_Data)
    {
        $this->_Attestation_Object = $AttestionObject;
        $this->_Authenticator_Data = $Authenticator_Data;
    }
